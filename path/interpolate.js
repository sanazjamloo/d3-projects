...
var interpolateTypes = [d3.curveLinear, d3.curveNatural, d3.curveStep, d3.curveBasis, d3.curveCardinal, d3.curveBundle];
...
for (var p = 0; p < 6; p++){
//Line generator
//Generators must be on top of the code.
      var line = d3.line()
